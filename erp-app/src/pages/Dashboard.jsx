...
export default function Dashboard() {
  ...
  useEffect(() => {
    async function fetchStats() {
      const [produits, clients, marques, commandes] = await Promise.all([
    ...
    <div>
      ...
      <div className="page-body">
        <div className="stats-grid">
          ...
          <StatCard icon={TrendingUp} label="Marques" value={stats.marques} color="#8E44AD" />
        ...
        <div className="card">
          ...
          <div className="card-body">
            <p style={{ color: 'var(--text-secondary)', lineHeight: 1.8 }}>
              Commencez par créer vos <strong>marques</strong>, puis ajoutez vos <strong>produits</strong>.
              Ensuite, créez vos <strong>clients</strong> et commencez à saisir des <strong>commandes</strong>.
            </p>
            <div style={{ display: 'flex', gap: 12, marginTop: 20, flexWrap: 'wrap' }}>
              <a href="/marques" className="btn btn-primary">+ Ajouter un marque</a>
